...
describe('v1.StorageTransferServiceClient', () => {
    ...
    describe('deleteTransferJob', () => {
        it('invokes deleteTransferJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.storagetransfer.v1.DeleteTransferJobRequest());
            request.jobName = '';
            const expectedHeaderRequestParams = "job_name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteTransferJob as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createAgentPool', () => {
        it('invokes createAgentPool without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.storagetransfer.v1.AgentPool());
            client.innerApiCalls.createAgentPool = stubSimpleCall(expectedResponse);
            const [response] = await client.createAgentPool(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createAgentPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateAgentPool', () => {
        it('invokes updateAgentPool without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateAgentPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getAgentPool', () => {
        it('invokes getAgentPool without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.storagetransfer.v1.GetAgentPoolRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAgentPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteAgentPool', () => {
        it('invokes deleteAgentPool without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.storagetransfer.v1.DeleteAgentPoolRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteAgentPool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listAgentPools', () => {
        it('invokes listAgentPools without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.storagetransfer.v1.ListAgentPoolsRequest());
            request.projectId = '';
            const expectedHeaderRequestParams = "project_id=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAgentPools as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
